...
// */
//public class PInputMethodPreference extends RestrictedSwitchPreference implements OnPreferenceClickListener,
//        OnPreferenceChangeListener {
//    private static final String TAG = PInputMethodPreference.class.getSimpleName();
...
//         */
//        void onSaveInputMethodPreference(PInputMethodPreference pref);
//    }
//
...
//     */
//    public PInputMethodPreference(final Context context, final InputMethodInfo imi,
...
//
//    @VisibleForTesting
//    PInputMethodPreference(final Context context, final InputMethodInfo imi,
...
//        mOnSaveListener.onSaveInputMethodPreference(PInputMethodPreference.this);
//        notifyChanged();
//    }
//
...
//    }
//
//    public int compareTo(final PInputMethodPreference rhs, final Collator collator) {
//        if (this == rhs) {
//            return 0;
//        }
