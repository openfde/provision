package com.android.oobe.language;

import static com.android.oobe.LanguageActivity.ADD_LOCALE;
...
public class LocaleListEditFragment extends Fragment {
    ...
    private List<LocaleStore.LocaleInfo> getUserLocaleList() {
        ...
        Log.w(TAG, "result.size = " + result.size());
        return result;
    }
...
//            Log.w(TAG, "-onCreateView add localeInfo: " + localeInfo);
    ...
    public void setRemoveMode(boolean mRemoveMode) {
        ...
        if (mRemoveMode) {
//            Log.w(TAG,"languageListener " + languageListener);
            ...
            languageListener.showAndHideNextButton(View.VISIBLE);
        }
