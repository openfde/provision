...
// */
//@Deprecated
//public class PSwitchPreference extends TwoStatePreference {
...
//            }
//
//            PSwitchPreference.this.setChecked(isChecked);
//        }
//    }
//
//    /**
...
//     */
//    public PSwitchPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//     *        the view. Can be 0 to not look for defaults.
//     */
//    public PSwitchPreference(Context context, AttributeSet attrs, int defStyleAttr) {
...
//     * @param attrs Style attributes that differ from the default
//     */
//    public PSwitchPreference(Context context, AttributeSet attrs) {
